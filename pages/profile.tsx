    ...
    <Content style={{ padding: "0 50px" }}>
      ...
      <Row gutter={[0, 0]}>
        <Col style={{ marginRight: 20 }}>
          <img
            src="https://mysilkyheart.github.io/assets/image/avatar.jpg"
            alt="Devi Adi Nufriana"
            width="240px"
          />
        </Col>
        <Col>
          ...
          <div>
            ...
            <br />a technology addict is never tired of stopping learning new
            things related to technology <br />
          </div>
          <br />
          <Row gutter={[8, 8]} style={{ marginBottom: 10 }}>
            ...
            <Col>
              <a
                target="_blank"
                href="https://www.linkedin.com/in/devi-adi-nufriana-6a174a12a/"
              >
...
Profiles.getLayout = (page) => {
  return <Navigasi>{page}</Navigasi>;
};
