...
const Calculator = () => {
  ...
  const calculate = (value) => {
    ...
    if (value == "=" && lastNumber != "") {
      ...
      setHistory([
        ...history,
        { firstNumber, lastNumber, result: result.toString(), operator },
      ]);
      clear();
    }
  };
        ...
        <Row gutter={[8, 8]}>
            ...
            <Row>
              <Col flex="auto">
                ...
                >
                  ...
                  {numberWithCommas(firstNumber)} <br />{" "}
                  {numberWithCommas(lastNumber)}{" "}
                </Title>
              </Col>
              <Col>
          ...
          <Col flex="auto">
            <Button
              onClick={() => setHistory([])}
              type="primary"
              style={{ marginBottom: 16, alignSelf: "self-end" }}
            >
              {" "}
              Clear History
            </Button>
